...
<div class="slideshow-container">
   ...
   <div class="slide">
    ...
    <div class="slide"> 
     ...
     <div class="filter" style="margin-left:40%;">
               <h3 style="padding-left:5%">Filtered for <?php echo $_POST['category'];?></h3>
               <input type="button" class="btn addtocart" value="Remove Filters" style="width:25rem;" onclick="window.location.href='index.php'">
               </div>
     <ul class="products">
     <?php
...
if ($conn1->connect_error) {
  echo "Connection failed";
				...
				$query = "SELECT * FROM productlist WHERE category='$category'";
